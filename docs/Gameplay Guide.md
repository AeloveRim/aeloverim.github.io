...
**Even if you don't intend to use the CBPC VRSex system itself, you may want to open the manual to select your orientation**, since the orientation system also applies to Sexlab/Ostim scenes and is required for sex scenes to affect divine affinities depending on the circumstances of the scene.
...
## Playing a thief
Pickpocketing and lockpicking are harder than usual if you're unskilled, but easier if you do raise your skills. [Pickpocket Reset VR](https://www.nexusmods.com/skyrimspecialedition/mods/174855) replenishes NPC inventories a few days after you pickpocket them. [Lock-related Loot](https://www.nexusmods.com/skyrimspecialedition/mods/11342) makes sure that Expert-level chest whose lock you just picked doesn't contain three gold pieces and a sweetroll. [Broken picks](https://www.nexusmods.com/skyrimspecialedition/mods/95275) makes it so breaking your lockpick will throw you out of the lockpicking minigame and force you to start from scratch. There will also be a cooldown of a few seconds before you can lockpick again so make sure to check for patrolling guards !

If lockpicking isn't your thing, you can simply knock on doors. If the owner is friendly or you pass a Speechcraft check, they may open willingly. Or, you can simply bash locks open. You will need a melee skill at 25 for novice, 50 for apprentice, 75 for adept or 100 for expert. Master locks cannot be bashed open. Just power attack a locked door or container a few times in a row to open it. This makes a lot of noise and will draw guards and enemies. There is also a chance this will increase the lock difficulty instead of opening it.

[Mum's the word NG](https://www.nexusmods.com/skyrimspecialedition/mods/77409) ensures that low-value loot will no longer be flagged as stolen and can be sold anywhere. Even for the more valuable loot, you will no longer have to join the thieves' guild to sell it : anything recognizably stolen can now be sold at any Khajiit caravan.

You will have a Disguise power you can toggle on and off. When it is on, if you are wearing at least 3 pieces of equipment belonging to a same faction and you spend some time hidden from view (wait until the notification appears), you will become disguised as a member of that faction. The disguise is not foolproof - its effectiveness depends on your Pickpocket skill, distance, and the Method Actor Pickpocket perks. You will lose all bounties incurred while in disguise if you manage to escape unrecognized.
