...
**Even if you don't intend to use the CBPC VRSex system itself, you may want to open the manual to select your orientation**, as the system will also apply its buffs/debuffs to Sexlab/Ostim scenes and affect divine affinities depending on the circumstances of the scene.
